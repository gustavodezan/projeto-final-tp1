...
public class FuncFazerPedido extends javax.swing.JFrame {
    ...
    private void btConfEscEstAActionPerformed(java.awt.event.ActionEvent evt) {                                              
    ...
    private void btCancEscEstAActionPerformed(java.awt.event.ActionEvent evt) {                                              
        this.dispose();
    }                                             

    private void btnConfPActionPerformed(java.awt.event.ActionEvent evt) {                                         
        for (int i=0;i < livrosped.size();i++){
        ...
        if (Conf){
            ...
            JOptionPane.showMessageDialog (null,"Limite de Livros foi estorado");
            livrosped.clear();
            this.carregarTabela2();
            }
    }                                        
