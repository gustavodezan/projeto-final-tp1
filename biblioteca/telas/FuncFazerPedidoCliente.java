 ...
 * @author jplim
 */
public class FuncFazerPedidoCliente extends javax.swing.JFrame {
    ...
    public FuncFazerPedidoCliente(Cliente cliente,GerenciarBiblioteca sistema){
        initComponents();
    ...
    private void btConfEscEstAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btConfEscEstAActionPerformed
        ...
        if (ind >=0 && ind < estantes.size()){
            new FuncEscolherLivPedCliente(estantes.get(ind),livrosped,this).setVisible(true);
        }
...
//            }
            ...
            try {
                ...
                Logger.getLogger(FuncFazerPedidoCliente.class.getName()).log(Level.SEVERE, null, ex);
            }
            livrosped.clear();
